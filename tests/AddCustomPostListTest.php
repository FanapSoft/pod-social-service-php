...
final class AddCustomPostListTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testAddCustomPostListAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'content' => '',
		...
		try {
			$result = $SocialService->addCustomPostList($params);
	...
	public function testAddCustomPostListRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'content' => '',
	...
	public function testAddCustomPostListValidationError()
	{
		...
		try {
			self::$SocialService->addCustomPostList($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->addCustomPostList($paramsWrongValue);
		} catch (ValidationException $e) {
