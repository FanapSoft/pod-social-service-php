...
final class AddUserPostTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testAddUserPostAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'content' => '',
		...
		try {
			$result = $SocialService->addUserPost($params);
	...
	public function testAddUserPostRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'content' => '',
	...
	public function testAddUserPostValidationError()
	{
		...
		try {
			self::$SocialService->addUserPost($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->addUserPost($paramsWrongValue);
		} catch (ValidationException $e) {
