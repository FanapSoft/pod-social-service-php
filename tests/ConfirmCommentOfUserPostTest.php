...
final class ConfirmCommentOfUserPostTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testConfirmCommentOfUserPostAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'commentId' => '',
		...
		try {
			$result = $SocialService->confirmCommentOfUserPost($params);
	...
	public function testConfirmCommentOfUserPostRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'commentId' => '',
	...
	public function testConfirmCommentOfUserPostValidationError()
	{
		...
		try {
			self::$SocialService->confirmCommentOfUserPost($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->confirmCommentOfUserPost($paramsWrongValue);
		} catch (ValidationException $e) {
