...
final class GetConfirmedCommentsTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testGetConfirmedCommentsAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'postId' => '',
		...
		try {
			$result = $SocialService->getConfirmedComments($params);
	...
	public function testGetConfirmedCommentsRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'postId' => '',
	...
	public function testGetConfirmedCommentsValidationError()
	{
		...
		try {
			self::$SocialService->getConfirmedComments($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->getConfirmedComments($paramsWrongValue);
		} catch (ValidationException $e) {
