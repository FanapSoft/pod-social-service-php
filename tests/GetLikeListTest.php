...
final class GetLikeListTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testGetLikeListAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'postId' => '',
		...
		try {
			$result = $SocialService->getLikeList($params);
	...
	public function testGetLikeListRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'postId' => '',
	...
	public function testGetLikeListValidationError()
	{
		...
		try {
			self::$SocialService->getLikeList($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->getLikeList($paramsWrongValue);
		} catch (ValidationException $e) {
