...
final class LoadUserPostTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testLoadUserPostAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'entityId' => '',
		...
		try {
			$result = $SocialService->loadUserPost($params);
	...
	public function testLoadUserPostRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'entityId' => '',
	...
	public function testLoadUserPostValidationError()
	{
		...
		try {
			self::$SocialService->loadUserPost($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->loadUserPost($paramsWrongValue);
		} catch (ValidationException $e) {
