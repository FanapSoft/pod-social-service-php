...
final class UnconfirmCommentOfUserPostTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testUnconfirmCommentOfUserPostAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'commentId' => '',
		...
		try {
			$result = $SocialService->unconfirmCommentOfUserPost($params);
	...
	public function testUnconfirmCommentOfUserPostRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'commentId' => '',
	...
	public function testUnconfirmCommentOfUserPostValidationError()
	{
		...
		try {
			self::$SocialService->unconfirmCommentOfUserPost($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->unconfirmCommentOfUserPost($paramsWrongValue);
		} catch (ValidationException $e) {
