...
final class UpdateCustomPostTest extends TestCase
{
    ...
    public function setUp(): void
   {
	...
	public function testUpdateCustomPostAllParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'entityId' => '',
		...
		try {
			$result = $SocialService->updateCustomPost($params);
	...
	public function testUpdateCustomPostRequiredParameters()
	{
		$params = [
			## ================= *Required Parameters  =================
			'entityId' => '',
	...
	public function testUpdateCustomPostValidationError()
	{
		...
		try {
			self::$SocialService->updateCustomPost($paramsWithoutRequired);
		} catch (ValidationException $e) {
		...
		try {
			self::$SocialService->updateCustomPost($paramsWrongValue);
		} catch (ValidationException $e) {
			...
			$this->assertArrayHasKey('version', $validation);
			$this->assertEquals('String value found, but an integer is required', $validation['version'][0]);
